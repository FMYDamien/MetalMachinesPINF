...
<footer>
        ...
        <nav>
            <ul class="menu-foot">
                    ...
                    <li><a href="qui-sommes-nous.php">L'entreprise</a></li>
                    <li><a href="competences.php">Savoir-faire</a></li>
                    ...
                    <?php    echo '<li><a href="../PHP/controleur.php?action=logout">Se déconnecter</a></li>';
                    } else {
        ...
        <?php if (isset($_SESSION['admin'])): ?>
            ...
            <div id="cropperModal" style="display:none; position:fixed; top:0; left:0; right:0; bottom:0; background:#000000cc; z-index:10000; justify-content:center; align-items:center;">
                <div style="background:white; padding:20px; border-radius:8px; max-width:90vw; max-height:90vh;">
                    ...
                    <div style="text-align:right; margin-top:10px;">
                        <button id="cancelCrop">Annuler</button>
                        <button id="confirmCrop">Valider</button>
                    </div>
                </div>
            </div>
            ...
            <div id="edit-controls">
                <button id="edit-toggle" title="Modifier le contenu">
                    <span id="edit-icon">&#9998;</span><!-- 🖉 -->
                    <span id="check-icon" style="display:none">&#10003;</span><!-- ✅ -->
                </button>
                <button id="edit-cancel" title="Annuler les modifications" style="display:none;">&#10006;</button><!-- ❌ -->
            </div>
...
window.addEventListener("DOMContentLoaded", function () {
    ...
    function updateDuration() {
        ...
        if (hours > 0) {
            span.textContent = `Connecté depuis ${hours} h ${minutes} min`;
        } else {
            span.textContent = `Connecté depuis ${minutes} min ${seconds} s`;
        }
    }
