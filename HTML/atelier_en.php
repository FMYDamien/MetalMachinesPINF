...
<head>
    ...
    <title>Workshop - MetalMachines</title>
...
<body>
    ...
    <main>
        ...
        <section class="box" id="intro">
            <h1 class="editable" data-key="1405">Workshop</h1>
            <p class="editable" data-key="1406">Workshop presentation.</p>
        </section>

        <!--Section de présentation 1-->
        <section class="box" id="about2">
            <div class="column1">
                <h2 class="editable" data-key="1407">To be completed!</h2>
            ...
            <div class="column2">
                <img id="img1" src="../img/image1.png" alt="Workshop image" class="editable" data-key="1409">
            </div>
        </section>
        ...
        <section class="box" id="about1">
            <div class="column2">
                <img id="img2" src="../img/image2.png" alt="Workshop image 2" class="editable" data-key="1410">
            </div>
            <div class="column1">
                <h2 class="editable" data-key="1411">To be completed!</h2>
        ...
        <section class="box" id="about3">
            <div class="column2">
                <img id="img3" src="../img/image3.png" alt="Workshop image 3" class="editable" data-key="1413">
            </div>
            <div class="column1">
                <img id="img4" src="../img/image4.png" alt="Workshop image 4" class="editable" data-key="1414">
            </div>
        </section>
    </main>
