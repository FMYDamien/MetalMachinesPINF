...
<head>
    ...
    <title>News - MetalMachines</title>
...
<body>
    ...
    <main>
        ...
        <section class="box" id="intro">
            <h1 class="editable" data-key="1399">News</h1>
            <p class="editable" data-key="1400">Read our latest news here.</p>
        </section>

        <!--Section de présentation 1-->
        <section class="box" id="about2">
            <div class="column1">
                <h2 class="editable" data-key="1401">Our latest project</h2>
                <p id="exception" class="editable" data-key="1402">Project (description, customer, etc.)</p>
            </div>
            <div class="column2">
                <img id="img1" src="../img/image1.png" alt="Project image" class="editable" data-key="1403">
            </div>
        </section> <br><br><br>
        ...
        <section class="box" id="about1">
            <div class="actu3">
                <h2 class="editable" data-key="1404">News on our networks</h2> <br><br><br> 
